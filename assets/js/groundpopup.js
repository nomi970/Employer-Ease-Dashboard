    ...
    const tour = introJs()
        .setOptions({
            steps: [
                ...
                {
                    element: '[data-step="15"]',
                    intro: `
                    <h2>User Profile</h2>
                        <div style="display: flex; align-items: center; gap: 15px;">
                        
                        <p>You can see your profile information here. In this feature you can edit update and add payment method to your profile</p>
                        <img height="40px" height="40px" src="./assets/images/employer-ease-pics/popup_avatar.svg" alt="Workforce Solutions" style="width:40px; height:40px;">
                            </div>
                        </div>`,
                    position: 'top'
                ...
                {
                    element: '[data-step="16"]',
                    intro: `
                    <h2>Language</h2>
                        <div style="display: flex; align-items: center; gap: 15px;">
                        
                        <p>You can toggle between your language in this section</p>
                        <img height="40px" height="40px" src="./assets/images/employer-ease-pics/popup_avatar.svg" alt="Workforce Solutions" style="width:40px; height:40px;">
                            </div>
                        </div>`,
                    position: 'top'
                ...
                {
                    element: '[data-step="17"]',
                    intro: `
                    <h2>Bizzy Chatbot</h2>
                        <div style="display: flex; align-items: center; gap: 15px;">
                        
                        <p>You can ask bizzy about Employer Ease features. Bizzy respond  immediately</p>
                        <img height="40px" height="40px" src="./assets/images/employer-ease-pics/popup_avatar.svg" alt="Workforce Solutions" style="width:40px; height:40px;">
                            </div>
                        </div>`,
                    position: 'top'
